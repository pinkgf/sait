...
class AdminController extends Controller
{
    ...
    public function actionAddUser()
    {
        ...
        if ($_POST) {
            ...
            $user->permission = isset($_POST['permission']) ? $_POST['permission'] : 'both';
            ...
            if ($user->save()) {
                Log::add('Добавление сотрудника', "Добавлен сотрудник {$user->username}");
    ...
    public function actionEditUser($id)
    {
        ...
        if ($_POST) {
            ...
            if ($user->save()) {
                Log::add('Редактирование сотрудника', "Изменены данные сотрудника {$user->username}");
    ...
    public function actionDeleteUser($id)
    {
        ...
        if ($user && $user->id != Yii::$app->user->id) {
            Log::add('Удаление сотрудника', "Удален сотрудник {$user->username}");
